...
func (c *streamServiceClient) MessageStream(ctx context.Context, opts ...grpc.CallOption) (StreamService_MessageStreamClient, error) {
	stream, err := c.cc.NewStream(ctx, &StreamService_ServiceDesc.Streams[0], "/pb.StreamService/MessageStream", opts...)
	if err != nil {
		return nil, err
	}
...
func (UnimplementedStreamServiceServer) MessageStream(StreamService_MessageStreamServer) error {
